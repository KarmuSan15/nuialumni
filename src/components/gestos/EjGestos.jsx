...
export default function EjGestos() {
  const [label, setLabel] = useState(null);
  const [bgColor, setBgColor] = useState('turquoise'); // Color inicial: azul turquesa
  ...
  const runDetection = async (model) => {
    if (
      ...
      // Cambiar el color del fondo si se detecta el gesto "point"
      if (label === "point") {
        setBgColor((prevColor) => {
          const newColor = prevColor === 'turquoise' ? 'pink' : 'turquoise';
          console.log(`Cambiando color del fondo a: ${newColor}`);
          return newColor;
        });
      } else if (label === "open") {
        console.log("scrolling down");
    ...
    <>
      <div
        style={{
          alignItems: 'center',
          display: 'flex',
          backgroundColor: bgColor, // Color dinámico del fondo
          flexDirection: 'column',
        }}
      >
        <div>
